...
| `FIRST_BANK` | 第一銀行 | html | spot, cash | [外幣匯率](https://www.firstbank.com.tw/sites/fcb/touch/1565688252532) | AUD, CAD, CHF, CNY, EUR, GBP, HKD, JPY, NZD, SEK, SGD, THB, TRY, USD, ZAR |
...
- 台灣銀行、將來銀行、國泰世華、土地銀行、台新銀行及台北富邦的請求可能需要 browser TLS fingerprint；未提供自訂 `fetch` 時套件會延遲載入 `impit`。
